...
(function withAngular(angular, navigator) {
  ...
  var A_DAY_IN_MILLISECONDS = 86400000
    ...
    return [
      ...
      '<span class="datapicker-title__year">',
      '{{year}}',
      '</span>',
      '<div class="datapicker-title__date">',
      '{{dayWeek}}, ',
      '{{day}}',
      ' {{month}}',
      '</div>',
    ...
    var toReturn = [
      '<div class="_720kb-datepicker-calendar__wrapper">',
      '</div>',
    ...
    var linkingFunction = function linkingFunction($scope, element, attr) {
      ...
      var selector = attr.selector
          ...
          , showCalendar = function showCalendar() {
            ...
            pageDatepickersWrapper = $window.document.getElementsByClassName('_720kb-datepicker-calendar__wrapper');
            ...
            if (theCalendar.classList) {
              ...
              pageDatepickersWrapper[0].classList.add('_720kb-datepicker-open');
      ...
      if(pageDatepickersWrapper) {
        if (pageDatepickersWrapper[0].classList) {
          pageDatepickersWrapper[0].classList.remove('_720kb-datepicker-open');
        }
      }
      ...
      weekday[5] = "Пт";
      weekday[6] = "Сб";
      $scope.dayWeek = weekday[d.getDay()];
      ...
      if ($scope.datepickerAppendTo &&
        ...
        angular.element(document).find('body').append($compile(angular.element(htmlTemplate))($scope, function afterCompile(el) {
          theCalendar = angular.element(el)[1];
      ...
      console.log('dest');
        ...
        angular.element($window).off('click focus focusin', onClickOnWindow);
        $('._720kb-datepicker-calendar__wrapper').remove();
        $('._720kb-datepicker-calendar').remove();
