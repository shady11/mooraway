...
@section('content')
    <div class="banner" style="background-image: url('interface/img/slide.jpg')">
        ...
        <div class="banner__content">
            ...
            <slider-top-component page="sender"></slider-top-component>
            <div class="category category_not-bg">
                <become-sender-component></become-sender-component>
            </div>
            <div class="video">
                ...
                <span class="wistia_embed wistia_async_rmpguvu3zm popover=true popoverContent=link" style="display:inline">
                    <a>
                        <span class="icon-play-yellow"><span class="icon-sprite"></span></span>
